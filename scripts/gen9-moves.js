...
async function gen9Update() {
    ...
    async function updateMoves() {
        ...
        let newGenMoves = [
            ...
            '650,ASALTOESPADON,Asalto Espadón,03B,100,DRAGON,Physical,0,00,0,abef,"Asalto espadón causa daño y no tiene ningún efecto secundario. Sin embargo, reduce el ataque y la defensa del usuario."',
            '651,MARTILLOCOLOSAL,Martillo colosal,03B,100,STEEL.Physical,0,00,0,bef,"Martillo colosal causa daño y no tiene ningún efecto secundario. Sin embargo, reduce el ataque y la defensa del usuario."'
        ];
